                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm flex flex-col justify-between relative">
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            <button className="bg-neutral-100 px-5 py-2 rounded-lg text-sm font-medium flex items-center justify-center cursor-pointer">Details</button>
                    ...
                    </div>                    <div className="bg-white rounded-2xl p-5 shadow-sm flex flex-col justify-between relative">
                        <div>
                            <span className="absolute top-4 right-4 inline-flex items-center gap-1.5 text-xs bg-neutral-100 px-2 py-0.5 rounded font-semibold">
                                <svg
                                    className="w-3 h-3"
